export const datasets = [
  {
    ...
    params: {
      ...
      energyFinalConsumBySecEJ: { units: "Final Energy Consumption by Sector (EJ)", group: "energy", region: "region", description: "Final energy consumption by sector in exajoules" },
      ...
      energyFinalSubsecByFuelIndusEJ: { units: "Industry Final Energy by Fuel (EJ)", group: "energy", region: "region", description: "Final energy consumption in buildings by fuel and subsector in exajoules" },
      energyFinalSubsecByFuelTranspEJ: { units: "Transportation Final Energy by Fuel (EJ)", group: "energy", region: "region", description: "Final energy consumption in transportation by fuel and subsector in exajoules" },
